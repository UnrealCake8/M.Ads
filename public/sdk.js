(function () {
  ...
  function renderAd(ad, placement) {
    return new Promise(function (resolve) {
      var format = ad.format === "text" || ad.format === "image" ? ad.format : "mixed";
      ...
      var continueButton = '<button data-mads-continue type="button" disabled style="min-height:46px;border:1px solid #e2e8f0;border-radius:14px;background:#fff;padding:0 17px;font:inherit;font-weight:700;color:#94a3b8;cursor:default">Continue in <span data-mads-count>3</span></button>';
  ...
  window.MAds = { show: show, version: "0.3.0" };
})();
